CREATE TABLE IF NOT EXISTS battlecity_x_comment_tasks (
  id TEXT PRIMARY KEY,
...
CREATE UNIQUE INDEX IF NOT EXISTS battlecity_x_comment_one_active ON battlecity_x_comment_tasks ((active)) WHERE active;
CREATE TABLE IF NOT EXISTS battlecity_x_comment_claims (
  task_id TEXT NOT NULL REFERENCES battlecity_x_comment_tasks(id) ON DELETE CASCADE,
