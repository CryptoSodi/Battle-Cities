...
- Mainnet BATC drop transfers use Oracle's limited BATC reward wallet. Refill it from the production treasury as needed; the treasury and mint-authority private keys must never be installed on the server.
