/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare-game-worker/wrangler.jsonc cloudflare-game-worker/worker-configuration.d.ts` (hash: 48896fc3bd0abfe28ec1f3aebc9ee704)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	API_BASE_URL: "https://api.battlecities.com";
	MATCHES: DurableObjectNamespace<import("./src/index").BattleCityMatch>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BattleCityMatch";
	}
