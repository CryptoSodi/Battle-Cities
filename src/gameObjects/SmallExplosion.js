...
exports.SmallExplosion = void 0;
const core_1 = require("../core");
const config = __importStar(require("../config"));
const explosionEffect_1 = require("./explosionEffect");
class SmallExplosion extends core_1.GameObject {
    constructor() {
        super(64, 64);
        this.zIndex = config.SMALL_EXPLOSION_Z_INDEX;
    ...
    setup({ spriteLoader, particles }) {
        this.animation = new core_1.Animation(spriteLoader.loadList([
            'explosion.small.1',
            'explosion.small.2',
            'explosion.small.3',
        ...
        (0, explosionEffect_1.emitExplosion)(particles, center.x, center.y, { scale: 0.45, smoke: false });
    }
    update(updateArgs) {
