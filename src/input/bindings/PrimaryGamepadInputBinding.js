...
exports.PrimaryGamepadInputBinding = void 0;
const core_1 = require("../../core");
const InputControl_1 = require("../InputControl");
class PrimaryGamepadInputBinding extends core_1.InputBinding {
    constructor() {
        super();
...
exports.PrimaryGamepadInputBinding = PrimaryGamepadInputBinding;
